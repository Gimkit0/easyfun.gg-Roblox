...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[9723], {
    ...
    79267: (e, t) => {
        function r(e, t, n=!1) {
            return t ? Object.keys(e).filter(e => n ? !t.includes(e) : t.includes(e)).reduce( (t, r) => (t[r] = e[r],
            t), {}) : {}
        }
        function n(e, t, r, n) {
        ...
        t.formatData = function(e, t) {
            ...
            let c = r(t, null == (l = e.scripts) ? void 0 : l.reduce( (e, t) => [...e, ...Array.isArray(t.params) ? t.params : []], []))
              ...
              , p = r(t, [null == (s = null == (u = e.html) ? void 0 : u.attributes.src) ? void 0 : s.slugParam])
              , f = r(t, [...Object.keys(c), ...Object.keys(d), ...Object.keys(p)], !0);
            return Object.assign(Object.assign({}, e), {
                html: e.html ? o(e.html.element, e.html.attributes, f, d, p) : null,
    ...
    92148: (e, t, r) => {
        ...
        s.Bk)()
          ...
          , [O,j] = y(w)
          , E = e => {
            let {__scopeTooltip: t, delayDuration: r=700, skipDelayDuration: o=300, disableHoverableContent: l=!1, children: a} = e
              , i = n.useRef(!0)
              , u = n.useRef(!1)
              , s = n.useRef(0);
            return n.useEffect( () => {
            ...
            m.jsx)(O, {
                ...
                onClose: n.useCallback( () => {
                    window.clearTimeout(s.current),
                    s.current = window.setTimeout( () => i.current = !0, o)
                }
                , [o]),
        ...
        var _ = "Tooltip"
          , [T,M] = y(_)
          , P = e => {
            let {__scopeTooltip: t, children: r, open: o, defaultOpen: l, onOpenChange: a, disableHoverableContent: i, delayDuration: c} = e
              , d = j(_, e.__scopeTooltip)
              , p = v(t)
              , [f,g] = n.useState(null)
              , y = (0,
            u.B)()
              , h = n.useRef(0)
              , w = null != i ? i : d.disableHoverableContent
              , O = null != c ? c : d.delayDuration
              , E = n.useRef(!1)
              , [M,P] = (0,
            b.i)({
                prop: o,
                ...
                onChange: e => {
                    e ? (d.onOpen(),
                    document.dispatchEvent(new CustomEvent(x))) : d.onClose(),
                    null == a || a(e)
                }
                ,
                caller: _
            })
              , C = n.useMemo( () => M ? E.current ? "delayed-open" : "instant-open" : "closed", [M])
              , k = n.useCallback( () => {
            ...
            m.jsx)(s.bL, {
                ...
                m.jsx)(T, {
                    ...
                    onTriggerEnter: n.useCallback( () => {
                        d.isOpenDelayedRef.current ? L() : k()
                    }
                    , [d.isOpenDelayedRef, L, k]),
                    onTriggerLeave: n.useCallback( () => {
                        w ? G() : (window.clearTimeout(h.current),
                        h.current = 0)
                    }
                    , [G, w]),
                    onOpen: k,
        ...
        var C = "TooltipTrigger"
          , k = n.forwardRef( (e, t) => {
            let {__scopeTooltip: r, ...a} = e
              ...
              , d = n.useRef(null)
              , f = (0,
            l.s)(t, d, i.onTriggerChange)
              , b = n.useRef(!1)
              , g = n.useRef(!1)
              , y = n.useCallback( () => b.current = !1, []);
            return n.useEffect( () => () => document.removeEventListener("pointerup", y), [y]),
            (0,
            m.jsx)(s.Mz, {
                asChild: !0,
                ...c,
                ...
                m.jsx)(p.sG.button, {
                    ...
                    ref: f,
                    onPointerMove: (0,
                    o.mK)(e.onPointerMove, e => {
                        "touch" !== e.pointerType && (g.current || u.isPointerInTransitRef.current || (i.onTriggerEnter(),
                        g.current = !0))
                    }
                    ),
                    onPointerLeave: (0,
                    o.mK)(e.onPointerLeave, () => {
                        i.onTriggerLeave(),
                        g.current = !1
                    }
                    ),
                    onPointerDown: (0,
                    o.mK)(e.onPointerDown, () => {
                        i.open && i.onClose(),
                        b.current = !0,
                    ...
                    onBlur: (0,
                    o.mK)(e.onBlur, i.onClose),
                    onClick: (0,
                    o.mK)(e.onClick, i.onClose)
                })
            })
        }
        );
        ...
        var A = "TooltipContent"
          , I = n.forwardRef( (e, t) => {
            let r = D(A, e.__scopeTooltip)
              , {forceMount: n=r.forceMount, side: o="top", ...l} = e
              , a = M(A, e.__scopeTooltip);
            return (0,
            m.jsx)(d.C, {
                present: n || a.open,
                children: a.disableHoverableContent ? (0,
                m.jsx)(B, {
                    side: o,
                    ...l,
                    ref: t
          ...
          , N = n.forwardRef( (e, t) => {
            let r = M(A, e.__scopeTooltip)
              , o = j(A, e.__scopeTooltip)
              , a = n.useRef(null)
              , i = (0,
            l.s)(t, a)
              , [u,s] = n.useState(null)
        ...
        f.Dc)("TooltipContent")
          , B = n.forwardRef( (e, t) => {
            let {__scopeTooltip: r, children: o, "aria-label": l, onEscapeKeyDown: a, onPointerDownOutside: u, ...c} = e
              , d = M(A, r)
              , p = v(r)
              , {onClose: f} = d;
            return n.useEffect( () => (document.addEventListener(x, f),
            () => document.removeEventListener(x, f)), [f]),
            n.useEffect( () => {
                if (d.trigger) {
                    let e = e => {
                        let t = e.target;
        ...
        let c = function(e) {
            ...
            a.useMemo)(function() {
                return {
                    ...
                    hours: Math.floor(g / 36e5) % 24,
                    minutes: Math.floor(g / 6e4) % 60,
                    seconds: Math.floor(g / 1e3) % 60,
                    milliseconds: Math.floor(g) % 1e3
                }
            }, [g]);
            return [g, h]
        }
