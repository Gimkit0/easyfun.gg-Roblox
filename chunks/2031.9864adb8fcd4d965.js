(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[2031], {
    6762: (t, e, i) => {
        "use strict";
        let {default: o, DraggableCore: r} = i(67351);
        t.exports = o,
        t.exports.default = o,
        t.exports.DraggableCore = r
    }
    ,
    12482: (t, e) => {
        "use strict";
        ...
        function o() {
            ...
            if ("undefined" == typeof window)
                return "";
            let o = null == (t = window.document) || null == (t = t.documentElement) ? void 0 : t.style;
            if (!o || e in o)
                return "";
    ...
    28032: (t, e, i) => {
        ...
        u.Bk)()
          , [D,P] = x(w)
          , R = t => {
            let {__scopePopover: e, children: i, open: r, defaultOpen: n, onOpenChange: s, modal: a=!1} = t
              , l = z(e)
              , h = o.useRef(null)
              , [d,c] = o.useState(!1)
              , [f,g] = (0,
            ...
            y.jsx)(u.bL, {
                ...
                y.jsx)(D, {
                    ...
                    open: f,
                    onOpenChange: g,
                    onOpenToggle: o.useCallback( () => g(t => !t), [g]),
                    hasCustomAnchor: d,
                    onCustomAnchorAdd: o.useCallback( () => c(!0), []),
                    onCustomAnchorRemove: o.useCallback( () => c(!1), []),
                    modal: a,
                    children: i
                })
            })
        ...
        var N = "PopoverAnchor";
        o.forwardRef( (t, e) => {
            let {__scopePopover: i, ...r} = t
              , n = P(N, i)
              , s = z(i)
              , {onCustomAnchorAdd: a, onCustomAnchorRemove: l} = n;
            return o.useEffect( () => (a(),
            () => l()), [a, l]),
            (0,
            y.jsx)(u.Mz, {
                ...s,
        ...
        var E = "PopoverTrigger"
          , M = o.forwardRef( (t, e) => {
            ...
            y.jsx)(f.sG.button, {
                ...
                ref: l,
                onClick: (0,
                r.mK)(t.onClick, s.onOpenToggle)
            });
            return s.hasCustomAnchor ? h : (0,
            y.jsx)(u.Mz, {
                asChild: !0,
                ...a,
                children: h
        ...
        var C = "PopoverPortal"
          ...
          , T = t => {
            let {__scopePopover: e, forceMount: i, children: o, container: r} = t
              , n = P(C, e);
            return (0,
            y.jsx)(O, {
                scope: e,
        ...
        var A = "PopoverContent"
          , H = o.forwardRef( (t, e) => {
            let i = W(A, t.__scopePopover)
              , {forceMount: o=i.forceMount, ...r} = t
              , n = P(A, t.__scopePopover);
            return (0,
            y.jsx)(c.C, {
                present: o || n.open,
                children: n.modal ? (0,
        ...
        H.displayName = A;
        var j = (0,
        g.TL)("PopoverContent.RemoveScroll")
          , k = o.forwardRef( (t, e) => {
            let i = P(A, t.__scopePopover)
              , s = o.useRef(null)
              , a = (0,
            n.s)(e, s)
              , l = o.useRef(!1);
            ...
            y.jsx)(v.A, {
                ...
                y.jsx)(_, {
                    ...
                    onCloseAutoFocus: (0,
                    r.mK)(t.onCloseAutoFocus, t => {
                        var e;
                        t.preventDefault(),
                        l.current || null == (e = i.triggerRef.current) || e.focus()
                    }
                    ),
                    onPointerDownOutside: (0,
                    r.mK)(t.onPointerDownOutside, t => {
                        let e = t.detail.originalEvent
                          , i = 0 === e.button && !0 === e.ctrlKey;
                        l.current = 2 === e.button || i
                    }
                    , {
                        checkForDefaultPrevented: !1
                    }),
                    onFocusOutside: (0,
                    r.mK)(t.onFocusOutside, t => t.preventDefault(), {
                        checkForDefaultPrevented: !1
                    })
                })
            })
          ...
          , L = o.forwardRef( (t, e) => {
            ...
            y.jsx)(_, {
                ...
                onCloseAutoFocus: e => {
                    var o, s;
                    null == (o = t.onCloseAutoFocus) || o.call(t, e),
                    e.defaultPrevented || (r.current || null == (s = i.triggerRef.current) || s.focus(),
                    e.preventDefault()),
                    r.current = !1,
                    n.current = !1
                }
                ...
                onInteractOutside: e => {
                    var o, s;
                    null == (o = t.onInteractOutside) || o.call(t, e),
                    e.defaultPrevented || (r.current = !0,
                    "pointerdown" === e.detail.originalEvent.type && (n.current = !0));
                    let a = e.target;
                    (null == (s = i.triggerRef.current) ? void 0 : s.contains(a)) && e.preventDefault(),
                    "focusin" === e.detail.originalEvent.type && n.current && e.preventDefault()
                }
            })
        }
        )
          , _ = o.forwardRef( (t, e) => {
            let {__scopePopover: i, trapFocus: o, onOpenAutoFocus: r, onCloseAutoFocus: n, disableOutsidePointerEvents: s, onEscapeKeyDown: p, onPointerDownOutside: d, onFocusOutside: c, onInteractOutside: f, ...g} = t
              , m = P(A, i)
              , b = z(i);
            return (0,
            l.Oh)(),
        ...
        o.forwardRef( (t, e) => {
            ...
            y.jsx)(f.sG.button, {
                ...
                ref: e,
                onClick: (0,
                r.mK)(t.onClick, () => n.onOpenChange(!1))
            })
        }
        ).displayName = X;
        var Y = o.forwardRef( (t, e) => {
            let {__scopePopover: i, ...o} = t
              , r = z(i);
            return (0,
            y.jsx)(u.i3, {
            ...
            n.A)("mousemove", function(e) {
                ...
                if (u) {
                    var d = u.getBoundingClientRect()
                      ...
                      , g = d.width
                      , m = d.height;
                    p.elementPosX = c + window.pageXOffset,
                    p.elementPosY = f + window.pageYOffset,
                    p.elementX = a - p.elementPosX,
                    p.elementY = h - p.elementPosY,
                    p.elementW = g,
                    p.elementH = m
                }
                l(p)
    ...
    60071: (t, e, i) => {
        ...
        e.createCSSTransform = function(t, e) {
            ...
            return {
                [(0,
                r.browserPrefixToKey)("transform", r.default)]: i
            }
        }
        ,
        ...
        e.getTouch = function(t, e) {
            ...
            o.findInArray)(t.targetTouches, t => e === t.identifier) || t.changedTouches && (0,
            o.findInArray)(t.changedTouches, t => e === t.identifier)
        }
        ,
        ...
        e.offsetXYFromParent = function(t, e, i) {
            let o = e === e.ownerDocument.body ? {
                left: 0,
                top: 0
            } : e.getBoundingClientRect();
            return {
                x: (t.clientX + e.scrollLeft - o.left) / i,
                y: (t.clientY + e.scrollTop - o.top) / i
            }
        }
        ,
        e.outerHeight = function(t) {
            let e = t.clientHeight
              , i = t.ownerDocument.defaultView.getComputedStyle(t);
            return e += (0,
            o.int)(i.borderTopWidth),
            e += (0,
            o.int)(i.borderBottomWidth)
        }
        ,
        e.outerWidth = function(t) {
            let e = t.clientWidth
              , i = t.ownerDocument.defaultView.getComputedStyle(t);
            return e += (0,
            o.int)(i.borderLeftWidth),
            e += (0,
            o.int)(i.borderRightWidth)
        }
        ,
        e.removeClassName = p,
        ...
        e.removeUserSelectStyles = function(t) {
            if (t)
                try {
                    if (t.body && p(t.body, "react-draggable-transparent-selection"),
                    t.selection)
                        t.selection.empty();
                    else {
        ...
        function a(t, e) {
            return s || (s = (0,
            o.findInArray)(["matches", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"], function(e) {
                return (0,
                o.isFunction)(t[e])
            })),
            !!(0,
            o.isFunction)(t[s]) && t[s](e)
        }
        function l(t, e, i) {
            let {x: o, y: r} = t
        ...
        let l = function(t, e) {
            ...
            a.A)(function() {
                ...
                if (e) {
                    var i = function() {
                        var t;
                        t = e === document ? document.scrollingElement ? {
    ...
    67351: (t, e, i) => {
        ...
        function g(t, e, i) {
            ...
            }(e, "string")) ? o : String(o))in t ? Object.defineProperty(t, e, {
                value: i,
                enumerable: !0,
                configurable: !0,
                writable: !0
        ...
        class m extends o.Component {
            static getDerivedStateFromProps(t, e) {
                ...
                return i && (!o || i.x !== o.x || i.y !== o.y) ? ((0,
                u.default)("Draggable: getDerivedStateFromProps %j", {
                    position: i,
                    prevPropsPosition: o
                }),
                {
            ...
            constructor(t) {
                ...
                g(this, "onDragStart", (t, e) => {
                    if ((0,
                    u.default)("Draggable: onDragStart: %j", e),
                    !1 === this.props.onStart(t, (0,
                    l.createDraggableData)(this, e)))
                        return !1;
                    this.setState({
                        dragging: !0,
                        dragged: !0
                ...
                g(this, "onDrag", (t, e) => {
                    if (!this.state.dragging)
                        return !1;
                    (0,
                    u.default)("Draggable: onDrag: %j", e);
                    let i = (0,
                    l.createDraggableData)(this, e)
                      , o = {
                        x: i.x,
                    ...
                    if (this.props.bounds) {
                        let {x: t, y: e} = o;
                        o.x += this.state.slackX,
                        o.y += this.state.slackY;
                        let[r,n] = (0,
                        l.getBoundPosition)(this, o.x, o.y);
                        o.x = r,
                        o.y = n,
                        o.slackX = this.state.slackX + (t - o.x),
                        o.slackY = this.state.slackY + (e - o.y),
                        i.x = o.x,
                        i.y = o.y,
                        i.deltaX = o.x - this.state.x,
                        i.deltaY = o.y - this.state.y
                    }
                    if (!1 === this.props.onDrag(t, i))
                        return !1;
                    this.setState(o)
                }
                ),
                g(this, "onDragStop", (t, e) => {
                    if (!this.state.dragging || !1 === this.props.onStop(t, (0,
                    l.createDraggableData)(this, e)))
                        return !1;
                    (0,
                    u.default)("Draggable: onDragStop: %j", e);
                    let i = {
                        dragging: !1,
                        slackX: 0,
                        slackY: 0
            ...
            findDOMNode() {
                var t, e;
                return null != (t = null == (e = this.props) || null == (e = e.nodeRef) ? void 0 : e.current) ? t : n.default.findDOMNode(this)
            }
            render() {
                let {axis: t, bounds: e, children: i, defaultPosition: r, defaultClassName: n, defaultClassNameDragging: h, defaultClassNameDragged: u, position: d, positionOffset: c, scale: g, ...m} = this.props
                  , b = {}
                  , v = null
                  , y = !d || this.state.dragging
                  , w = d || r
                  , x = {
                    x: (0,
                    l.canDragX)(this) && y ? this.state.x : w.x,
                    y: (0,
                    l.canDragY)(this) && y ? this.state.y : w.y
                };
                this.state.isElementSVG ? v = (0,
                a.createSVGTransform)(x, c) : b = (0,
                a.createCSSTransform)(x, c);
                let S = (0,
                s.default)(i.props.className || "", n, {
                    [h]: this.state.dragging,
                    [u]: this.state.dragged
                });
                return o.createElement(p.default, f({}, m, {
                    onStart: this.onDragStart,
                    onDrag: this.onDrag,
                    onStop: this.onDragStop
                }), o.cloneElement(o.Children.only(i), {
                    className: S,
                    style: {
                        ...i.props.style,
                        ...b
    ...
    78866: (t, e, i) => {
        ...
        e.getBoundPosition = function(t, e, i) {
            ...
            let l = n(t);
            if ("string" == typeof a) {
                let t, {ownerDocument: e} = l, i = e.defaultView;
                if (!((t = "parent" === a ? l.parentNode : e.querySelector(a))instanceof i.HTMLElement))
                    throw Error('Bounds selector "' + a + '" could not find an element.');
                let n = i.getComputedStyle(l)
                  , s = i.getComputedStyle(t);
                a = {
                    left: -l.offsetLeft + (0,
                    o.int)(s.paddingLeft) + (0,
                    o.int)(n.marginLeft),
                    top: -l.offsetTop + (0,
                    o.int)(s.paddingTop) + (0,
                    o.int)(n.marginTop),
                    right: (0,
                    r.innerWidth)(t) - (0,
                    r.outerWidth)(l) - l.offsetLeft + (0,
                    o.int)(s.paddingRight) - (0,
                    o.int)(n.marginRight),
                    bottom: (0,
                    r.innerHeight)(t) - (0,
                    r.outerHeight)(l) - l.offsetTop + (0,
                    o.int)(s.paddingBottom) - (0,
                    o.int)(n.marginBottom)
                }
            }
            return (0,
            o.isNum)(a.right) && (e = Math.min(e, a.right)),
            (0,
            o.isNum)(a.bottom) && (i = Math.min(i, a.bottom)),
            (0,
            o.isNum)(a.left) && (e = Math.max(e, a.left)),
            (0,
            o.isNum)(a.top) && (i = Math.max(i, a.top)),
            [e, i]
        }
        ,
        e.getControlPosition = function(t, e, i) {
            let o = "number" == typeof e ? (0,
            r.getTouch)(t, e) : null;
            ...
            return (0,
            r.offsetXYFromParent)(o || t, a, i.props.scale)
        }
        ,
    ...
    79802: (t, e, i) => {
        ...
        o.memo)(function(t) {
          ...
          , R = function(t) {
            function e(e) {
                var i, o, r, n, s = t.call(this, e) || this;
                return s.ratio = 1,
                s.resizable = null,
                s.parentLeft = 0,
                s.parentTop = 0,
                ...
                s.appendBase = function() {
                    ...
                    e.classList ? e.classList.add(P) : e.className += P,
                    t.appendChild(e),
                    e
                }
                ,
                ...
                s.state = {
                    isResizing: !1,
                    width: null != (o = null == (i = s.propsSize) ? void 0 : i.width) ? o : "auto",
                    height: null != (n = null == (r = s.propsSize) ? void 0 : r.height) ? n : "auto",
                    direction: "right",
                    original: {
                        x: 0,
                        y: 0,
                    ...
                    var t = this
                      ...
                      , i = function(e) {
                        ...
                        if (void 0 === t.state[e] || "auto" === t.state[e])
                            return "auto";
                        if (t.propsSize && t.propsSize[e] && (null == (i = t.propsSize[e]) ? void 0 : i.toString().endsWith("%"))) {
                            if (t.state[e].toString().endsWith("%"))
                                return t.state[e].toString();
                            var o = t.getParentSize()
                              , r = Number(t.state[e].toString().replace("px", "")) / o[e] * 100;
                            return "".concat(r, "%")
                        }
                        return S(t.state[e])
                    };
                    return {
                        width: e && void 0 !== e.width && !this.state.isResizing ? S(e.width) : i("width"),
                        height: e && void 0 !== e.height && !this.state.isResizing ? S(e.height) : i("height")
                    }
                },
                enumerable: !1,
                configurable: !0
            ...
            e.prototype.getParentSize = function() {
                ...
                return e && (this.parentNode.style.flexWrap = i),
                this.removeBase(t),
                o
            }
            ,
            ...
            e.prototype.calculateNewMaxFromBoundary = function(t, e) {
                var i, o, r = this.props.boundsByDirection, n = this.state.direction, s = r && y("left", n), a = r && y("top", n);
                if ("parent" === this.props.bounds) {
                    var l = this.parentNode;
                    l && (i = s ? this.resizableRight - this.parentLeft : l.offsetWidth + (this.parentLeft - this.resizableLeft),
                    o = a ? this.resizableBottom - this.parentTop : l.offsetHeight + (this.parentTop - this.resizableTop))
                } else
                    "window" === this.props.bounds ? this.window && (i = s ? this.resizableRight : this.window.innerWidth - this.resizableLeft,
                    o = a ? this.resizableBottom : this.window.innerHeight - this.resizableTop) : this.props.bounds && (i = s ? this.resizableRight - this.targetLeft : this.props.bounds.offsetWidth + (this.targetLeft - this.resizableLeft),
                    o = a ? this.resizableBottom - this.targetTop : this.props.bounds.offsetHeight + (this.targetTop - this.resizableTop));
                return i && Number.isFinite(i) && (t = t && t < i ? t : i),
            ...
            e.prototype.calculateNewSizeFromDirection = function(t, e) {
                var i, o = this.props.scale || 1, r = Array.isArray(i = this.props.resizeRatio || 1) ? i : [i, i], n = r[0], s = r[1], a = this.state, l = a.direction, h = a.original, p = this.props, u = p.lockAspectRatio, d = p.lockAspectRatioExtraHeight, c = p.lockAspectRatioExtraWidth, f = h.width, g = h.height, m = d || 0, b = c || 0;
                return y("right", l) && (f = h.width + (t - h.x) * n / o,
                u && (g = (f - b) / this.ratio + m)),
                y("left", l) && (f = h.width - (t - h.x) * n / o,
                u && (g = (f - b) / this.ratio + m)),
                y("bottom", l) && (g = h.height + (e - h.y) * s / o,
                u && (f = (g - m) * this.ratio + b)),
                y("top", l) && (g = h.height - (e - h.y) * s / o,
                u && (f = (g - m) * this.ratio + b)),
                {
                    newWidth: f,
                    newHeight: g
            ...
            e.prototype.calculateNewSizeFromAspectRatio = function(t, e, i, o) {
                var r = this.props
                  ...
                  , h = void 0 === i.width || i.width < 0 ? t : i.width
                ...
                if (n) {
                    var f = (p - d) * this.ratio + c
                      ...
                      , y = Math.max(p, m)
                      , w = Math.min(u, v);
                    t = b(t, Math.max(l, f), Math.min(h, g)),
                    e = b(e, y, w)
                } else
                    t = b(t, l, h),
                    e = b(e, p, u);
            ...
            e.prototype.setBoundingClientRect = function() {
                ...
                if (this.resizable) {
                    var r = this.resizable.getBoundingClientRect()
                      ...
                      , a = r.right
                      , l = r.bottom;
                    this.resizableLeft = n * t,
                    this.resizableRight = a * t,
                    this.resizableTop = s * t,
            ...
            e.prototype.onResizeStart = function(t, e) {
                if (this.resizable && this.window) {
                    var i, o, r = 0, n = 0;
                    if (t.nativeEvent && ((i = t.nativeEvent).clientX || 0 === i.clientX) && (i.clientY || 0 === i.clientY) ? (r = t.nativeEvent.clientX,
                    n = t.nativeEvent.clientY) : t.nativeEvent && w(t.nativeEvent) && (r = t.nativeEvent.touches[0].clientX,
            ...
            e.prototype.onMouseMove = function(t) {
                ...
                if (this.state.isResizing && this.resizable && this.window) {
                    ...
                    var i, o, r, n, s, l, h = this.props, p = h.maxWidth, u = h.maxHeight, d = h.minWidth, c = h.minHeight, f = w(t) ? t.touches[0].clientX : t.clientX, g = w(t) ? t.touches[0].clientY : t.clientY, m = this.state, b = m.direction, y = m.original, S = m.width, D = m.height, P = this.getParentSize(), R = (i = this.window.innerWidth,
                    o = this.window.innerHeight,
                    r = p,
                    n = u,
                    s = d,
                    l = c,
                    ...
                    d = R.minWidth,
                    c = R.minHeight;
                    var N = this.calculateNewSizeFromDirection(f, g)
                      , E = N.newHeight
                      , M = N.newWidth
                      , C = this.calculateNewMaxFromBoundary(p, u);
                    this.props.snap && this.props.snap.x && (M = x(M, this.props.snap.x, this.props.snapGap)),
                    this.props.snap && this.props.snap.y && (E = x(E, this.props.snap.y, this.props.snapGap));
                    var O = this.calculateNewSizeFromAspectRatio(M, E, {
                        width: C.maxWidth,
                        height: C.maxHeight
                    }, {
                        width: d,
                    ...
                    E = O.newHeight,
                    this.props.grid) {
                        var W = v(M, this.props.grid[0], this.props.gridGap ? this.props.gridGap[0] : 0)
                          , T = v(E, this.props.grid[1], this.props.gridGap ? this.props.gridGap[1] : 0)
                          , A = this.props.snapGap || 0
                          , H = 0 === A || Math.abs(W - M) <= A ? W : M
                          , j = 0 === A || Math.abs(T - E) <= A ? T : E;
                        M = H,
                        E = j
                    }
                    var k = {
                    ...
                    S && "string" == typeof S) {
                        if (S.endsWith("%")) {
                            ...
                            var _ = M / this.window.innerWidth * 100;
                            M = "".concat(_, "vw")
                        } else if (S.endsWith("vh")) {
                            var X = M / this.window.innerHeight * 100;
                            M = "".concat(X, "vh")
                        }
                    }
                    if (D && "string" == typeof D) {
                        if (D.endsWith("%")) {
                            var L = E / P.height * 100;
                            E = "".concat(L, "%")
                        } else if (D.endsWith("vw")) {
                            var _ = E / this.window.innerWidth * 100;
                            E = "".concat(_, "vw")
                        } else if (D.endsWith("vh")) {
                            var X = E / this.window.innerHeight * 100;
                            E = "".concat(X, "vh")
                        }
                    }
                    var Y = {
                        width: this.createSizeForCssProperty(M, "width"),
                        height: this.createSizeForCssProperty(E, "height")
                    };
                    "row" === this.flexDir ? Y.flexBasis = Y.width : "column" === this.flexDir && (Y.flexBasis = Y.height);
                    var B = this.state.width !== Y.width
                      , F = this.state.height !== Y.height
                      , U = this.state.flexBasis !== Y.flexBasis
                      , G = B || F || U;
                    G && (0,
            ...
            e.prototype.onMouseUp = function(t) {
                var e, i, o = this.state, r = o.isResizing, n = o.direction;
                o.original,
                r && this.resizable && (this.props.onResizeStop && this.props.onResizeStop(t, n, this.resizable, this.delta),
                this.props.size && this.setState({
                    width: null != (e = this.props.size.width) ? e : "auto",
                    height: null != (i = this.props.size.height) ? i : "auto"
                }),
                this.unbindEvents(),
                this.setState({
                    isResizing: !1,
            ...
            e.prototype.updateSize = function(t) {
                var e, i;
                this.setState({
                    width: null != (e = t.width) ? e : "auto",
                    height: null != (i = t.height) ? i : "auto"
                })
            }
            ,
            e.prototype.renderResizer = function() {
                ...
                if (!i)
                    return null;
                var h = Object.keys(i).map(function(e) {
                    return !1 !== i[e] ? (0,
                    s.jsx)(c, {
                        direction: e,
            ...
            e.prototype.render = function() {
                var t = this
                  , e = Object.keys(this.props).reduce(function(e, i) {
                    return -1 !== D.indexOf(i) || (e[i] = t.props[i]),
                    e
                }, {})
                  , i = g(g(g({
                    position: "relative",
                ...
                s.jsxs)(o, g({
                    ...
                    children: [this.state.isResizing && (0,
                    s.jsx)("div", {
          ...
          , C = function(t) {
            ...
            return N(i, t),
            i.prototype = null === t ? Object.create(t) : (e.prototype = t.prototype,
            new e),
            ...
            i.prototype.onDragStart = function(t, e) {
                ...
                var i, o = this.getDraggablePosition();
                ...
                this.props.bounds) {
                    ...
                    if ("parent" === this.props.bounds)
                        ...
                        var s = r.getBoundingClientRect()
                          ...
                          , p = -(a - r.offsetLeft * n - h.left) / n
                          , u = -(l - r.offsetTop * n - h.top) / n
                        ...
                        var f = r.getBoundingClientRect()
                          ...
                          , c = (window.innerHeight - this.resizable.size.height * n) / n + v;
                        return this.setState({
                            bounds: {
                                top: v,
                                right: d,
                        ...
                        "string" == typeof this.props.bounds ? i = document.querySelector(this.props.bounds) : this.props.bounds instanceof HTMLElement && (i = this.props.bounds);
                    if (i instanceof HTMLElement && r instanceof HTMLElement) {
                        ...
                        if (this.resizable) {
                            ...
                            this.setState({
                                bounds: {
                                    top: R - N.top,
                                    right: P + (i.offsetWidth - this.resizable.size.width) - N.left / n,
                                    bottom: R + (i.offsetHeight - this.resizable.size.height) - N.top,
                                    left: P - N.left / n
                                }
                            })
                        }
            ...
            i.prototype.onDrag = function(t, e) {
                if (this.props.onDrag) {
                    ...
                    if (!this.props.dragAxis || "both" === this.props.dragAxis)
                        return this.props.onDrag(t, E(E({}, e), {
                            x: e.x + o,
                            y: e.y + r
                        }));
            ...
            i.prototype.onDragStop = function(t, e) {
                if (this.props.onDragStop) {
                    var i = this.offsetFromParent
                      ...
                      , r = i.top;
                    if (!this.props.dragAxis || "both" === this.props.dragAxis)
                        return this.props.onDragStop(t, E(E({}, e), {
                            x: e.x + o,
                            y: e.y + r
                        }));
                    if ("x" === this.props.dragAxis)
            ...
            ,
            i.prototype.onResizeStart = function(t, e, i) {
                t.stopPropagation(),
                this.setState({
                    resizing: !0
                });
                ...
                this.props.bounds) {
                    ...
                    if (l instanceof Element && (a instanceof HTMLElement || a === window) && s instanceof HTMLElement) {
                        ...
                        var f = l.getBoundingClientRect()
                          ...
                          , x = this.getOffsetHeight(a)
                          , S = e.toLowerCase().endsWith("left")
                          , z = e.toLowerCase().endsWith("right")
                          , D = e.startsWith("top")
                          , P = e.startsWith("bottom");
                        if ((S || D) && this.resizable) {
                            var R = (g - v) / o + this.resizable.size.width;
                            this.setState({
                                maxWidth: R > Number(p) ? p : R
                            })
                        }
                        if (z || this.props.lockAspectRatio && !S && !D) {
                            var R = w + (v - g) / o;
                            this.setState({
                                maxWidth: R > Number(p) ? p : R
                            })
                        }
                        if ((D || S) && this.resizable) {
                            var R = (m - y) / o + this.resizable.size.height;
                            this.setState({
                                maxHeight: R > Number(u) ? u : R
                            })
                        }
                        if (P || this.props.lockAspectRatio && !D && !S) {
                            var R = x + (y - m) / o;
                            this.setState({
                                maxHeight: R > Number(u) ? u : R
                            })
            ...
            ,
            i.prototype.onResize = function(t, e, i, o) {
                var r = this
                  , n = {
                  ...
                  , s = -o.width
                  , l = -o.height;
                ["top", "left", "topLeft", "bottomLeft", "topRight"].includes(e) && ("bottomLeft" === e ? n.x += s : ("topRight" === e || (n.x += s),
                n.y += l));
                var h = this.draggable.state;
                (n.x !== h.x || n.y !== h.y) && (0,
                a.flushSync)(function() {
                    r.draggable.setState(n)
                }),
                this.updateOffsetFromParent();
                ...
                this.props.onResize && this.props.onResize(t, e, i, o, {
                    x: u,
                    y: d
                })
            }
            ,
            i.prototype.onResizeStop = function(t, e, i, o) {
                this.setState({
                    resizing: !1
                });
                ...
                this.props.onResizeStop && this.props.onResizeStop(t, e, i, o, this.resizingPosition)
            }
            ,
            ...
            i.prototype.updateOffsetFromParent = function() {
                ...
                this.offsetFromParent = {
                    left: s.left - r + l - a.x * t,
                    top: s.top - n + h - a.y * t
                }
            }
            ,
            i.prototype.render = function() {
                var t, e = this, i = this.props, r = i.disableDragging, s = i.style, a = i.dragHandleClassName, l = i.position, h = i.onMouseDown, p = i.onMouseUp, u = i.dragAxis, d = i.dragGrid, c = i.bounds, f = i.enableUserSelectHack, g = i.cancel, m = i.children, b = (i.onResizeStart,
                i.onResize,
                i.onResizeStop,
                i.onDragStart,
                i.onDrag,
                i.onDragStop,
                i.resizeHandleStyles), v = i.resizeHandleClasses, y = i.resizeHandleComponent, w = i.enableResizing, x = i.resizeGrid, S = i.resizeHandleWrapperClass, z = i.resizeHandleWrapperStyle, D = i.scale, P = i.allowAnyClick, N = i.dragPositionOffset, C = function(t, e) {
                    var i = {};
                    for (var o in t)
                        Object.prototype.hasOwnProperty.call(t, o) && 0 > e.indexOf(o) && (i[o] = t[o]);
                    if (null != t && "function" == typeof Object.getOwnPropertySymbols)
                        for (var r = 0, o = Object.getOwnPropertySymbols(t); r < o.length; r++)
                            0 > e.indexOf(o[r]) && Object.prototype.propertyIsEnumerable.call(t, o[r]) && (i[o[r]] = t[o[r]]);
                    return i
                }(i, ["disableDragging", "style", "dragHandleClassName", "position", "onMouseDown", "onMouseUp", "dragAxis", "dragGrid", "bounds", "enableUserSelectHack", "cancel", "children", "onResizeStart", "onResize", "onResizeStop", "onDragStart", "onDrag", "onDragStop", "resizeHandleStyles", "resizeHandleClasses", "resizeHandleComponent", "enableResizing", "resizeGrid", "resizeHandleWrapperClass", "resizeHandleWrapperStyle", "scale", "allowAnyClick", "dragPositionOffset"]), O = this.props.default ? E({}, this.props.default) : void 0;
                delete C.default;
                var W = E(E(E({}, M), r || a ? {
                    cursor: "auto"
                } : {
                ...
                var j = this.state.resizing ? void 0 : t
                ...
                o.createElement)(R, E({}, C, {
                    ref: function(t) {
                        t && (e.resizable = t,
                        e.resizableElement.current = t.resizable)
                    },
                    defaultSize: O,
        ...
        class g extends o.Component {
            constructor() {
                ...
                d(this, "handleDragStart", t => {
                    if (this.props.onMouseDown(t),
                    !this.props.allowAnyClick && "number" == typeof t.button && 0 !== t.button)
                        return !1;
                    ...
                    if (this.props.disabled || !(t.target instanceof i.defaultView.Node) || this.props.handle && !(0,
                    s.matchesSelectorAndParentsTo)(t.target, this.props.handle, e) || this.props.cancel && (0,
                    s.matchesSelectorAndParentsTo)(t.target, this.props.cancel, e))
                        return;
                    "touchstart" === t.type && t.preventDefault();
                    let o = (0,
                    s.getTouchIdentifier)(t);
                    this.touchIdentifier = o;
                    let r = (0,
                    a.getControlPosition)(t, o, this);
                    if (null == r)
                        return;
                    let {x: n, y: l} = r
                      , p = (0,
                    a.createCoreData)(this, n, l);
                    (0,
                    h.default)("DraggableCore: handleDragStart: %j", p),
                    (0,
                    h.default)("calling", this.props.onStart),
                    !1 !== this.props.onStart(t, p) && !1 !== this.mounted && (this.props.enableUserSelectHack && (0,
                    s.addUserSelectStyles)(i),
                    this.dragging = !0,
                    this.lastX = n,
                    this.lastY = l,
                    (0,
                    s.addEvent)(i, f.move, this.handleDrag),
                    (0,
                    s.addEvent)(i, f.stop, this.handleDragStop))
                }
                ),
                d(this, "handleDrag", t => {
                    let e = (0,
                    a.getControlPosition)(t, this.touchIdentifier, this);
                    if (null == e)
                        return;
                    let {x: i, y: o} = e;
                    if (Array.isArray(this.props.grid)) {
                        let t = i - this.lastX
                          , e = o - this.lastY;
                        if ([t,e] = (0,
                        a.snapToGrid)(this.props.grid, t, e),
                        !t && !e)
                            return;
                        i = this.lastX + t,
                        o = this.lastY + e
                    ...
                    let r = (0,
                    a.createCoreData)(this, i, o);
                    if ((0,
                    h.default)("DraggableCore: handleDrag: %j", r),
                    !1 === this.props.onDrag(t, r) || !1 === this.mounted) {
                        try {
                ...
                d(this, "handleDragStop", t => {
                    ...
                    let r = (0,
                    a.createCoreData)(this, i, o);
                    if (!1 === this.props.onStop(t, r) || !1 === this.mounted)
                        return !1;
                    let n = this.findDOMNode();
                    n && this.props.enableUserSelectHack && (0,
                    s.removeUserSelectStyles)(n.ownerDocument),
                    (0,
                    h.default)("DraggableCore: handleDragStop: %j", r),
                    this.dragging = !1,
                    this.lastX = NaN,
                    this.lastY = NaN,
                    n && ((0,
                    h.default)("DraggableCore: Removing handlers"),
                    (0,
                    s.removeEvent)(n.ownerDocument, f.move, this.handleDrag),
                    (0,
                    s.removeEvent)(n.ownerDocument, f.stop, this.handleDragStop))
                }
                ),
                d(this, "onMouseDown", t => (f = c.mouse,
                this.handleDragStart(t))),
                d(this, "onMouseUp", t => (f = c.mouse,
                this.handleDragStop(t))),
                d(this, "onTouchStart", t => (f = c.touch,
                this.handleDragStart(t))),
                d(this, "onTouchEnd", t => (f = c.touch,
                this.handleDragStop(t)))
            }
            componentDidMount() {
                this.mounted = !0;
                ...
                t && (0,
                s.addEvent)(t, c.touch.start, this.onTouchStart, {
                    passive: !1
                })
            }
            componentWillUnmount() {
                ...
                if (t) {
                    ...
                    (0,
                    s.removeEvent)(e, c.mouse.move, this.handleDrag),
                    (0,
                    s.removeEvent)(e, c.touch.move, this.handleDrag),
                    (0,
                    s.removeEvent)(e, c.mouse.stop, this.handleDragStop),
                    (0,
                    s.removeEvent)(e, c.touch.stop, this.handleDragStop),
                    (0,
                    s.removeEvent)(t, c.touch.start, this.onTouchStart, {
                        passive: !1
                    }),
                    this.props.enableUserSelectHack && (0,
                    s.removeUserSelectStyles)(e)
                }
            }
            findDOMNode() {
                var t, e;
                return null != (t = this.props) && t.nodeRef ? null == (e = this.props) || null == (e = e.nodeRef) ? void 0 : e.current : n.default.findDOMNode(this)
            }
            render() {
    ...
    87441: (t, e, i) => {
        ...
        let n = function(t) {
            ...
            r.e)(i[0])) ? e.getRootNode() : document : document
        };
        var s = i(73229);
        function a(t, e, i) {
            void 0 === i && (i = "click");
            ...
            s.A)(function() {
                var t = function(t) {
                    (Array.isArray(e) ? e : [e]).some(function(e) {
                        var i = (0,
                        r.e)(e);
                        return !i || i.contains(t.target)
                    }) || a.current(t)
                }
                  , o = n(e)
                  , s = Array.isArray(i) ? i : [i];
                return s.forEach(function(e) {
                    return o.addEventListener(e, t)
                }),
                function() {
                    s.forEach(function(e) {
                        return o.removeEventListener(e, t)
                    })
                }
            }, Array.isArray(i) ? i : [i], e)
        }
    }
    ,
    95673: t => {
    ...
    99316: (t, e) => {
        ...
        e.dontSetMe = function(t, e, i) {
            if (t[e])
                return Error("Invalid prop ".concat(e, " passed to ").concat(i, " - do not set this, set it on the child."))
        }
        ,
        e.findInArray = function(t, e) {
            for (let i = 0, o = t.length; i < o; i++)
                if (e.apply(e, [t[i], i, t]))
                    return t[i]
        }
        ,
        e.int = function(t) {
