"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[6115, 7464], {
    15285: (e, t, n) => {
        n.d(t, {
            A: () => p
        });
        var l, a, r = n(6379), i = n(96820), c = n(55247), s = n(2285), o = n(60574), u = n(94907);
        function d() {
        ...
        function p() {
            let e = (0,
            o.c3)("cloud-game-area")
              , t = [e("game-quality-4"), e("game-quality-3"), e("game-quality-2"), e("game-quality-1")]
              , n = (0,
            c.useAtomValue)(m.C8)
              , l = e => t.length - e - 1
              , a = (0,
            s.yF)( (e, t, n) => {
              ...
              , d = (0,
            u.useRef)(document.querySelector("#fullscreen-element"));
            return (0,
            r.jsxs)(h.m_, {
                children: [(0,
                r.jsx)(h.k$, {
                ...
                r.jsx)(h.ZI, {
                    ...
                    r.jsx)("div", {
                        ...
                        r.jsx)("div", {
                            className: "cursor-pointer py-1 text-3 lh-4 transition-all data-[active=true]:c-cyan-5 hover:c-cyan-5",
                            "data-active": t === l(n),
                            onClick: () => a(t),
                            children: e
                        }, e))
    ...
    18269: (e, t, n) => {
        ...
        function s(e) {
            ...
            l.jsxs)("div", {
                className: (0,
                r.A)("w-fit flex items-center rd-full bg-white-1 bg-op-5 p-1.5 pis-2", t),
                ...n,
                children: [(0,
                l.jsx)("svg", {
                    className: "size-4",
                ...
                l.jsxs)("div", {
                    className: "mis-1 flex-center flex-shrink-1 ws-nowrap c-cyan-5",
                    children: [(0,
                    l.jsx)("span", {
                        className: "inline-flex justify-center rd-1 rd-full bg-black-2 p-1 text-3.5 font-600 lh-4",
                        children: String(u.hours).padStart(2, "0")
                    }), (0,
                    l.jsx)("span", {
                        className: "inline-block h-4 w-2.5 text-center c-cyan-5",
                        children: ":"
                    }), (0,
                    l.jsx)("span", {
                        className: "inline-flex justify-center rd-1 rd-full bg-black-2 p-1 text-3.5 font-600 lh-4",
                        children: String(u.minutes).padStart(2, "0")
                    }), (0,
                    l.jsx)("span", {
                        className: "inline-block h-4 w-2.5 text-center c-cyan-5",
                        children: ":"
                    ...
                    l.jsx)("span", {
                        className: "inline-flex justify-center rd-1 rd-full bg-black-2 p-1 text-3.5 font-600 lh-4",
                        children: String(u.seconds).padStart(2, "0")
                    })]
                })]
            })
        }
    ...
    24148: (e, t, n) => {
        ...
        var l, a = n(6379), r = n(96820), i = n(2285), c = n(60574), s = n(94907);
        function o() {
        ...
        function v(e) {
            let t = (0,
            i.yF)(e => {
                let {control: t} = e(f.Lp);
                t.triggerSystemKey(m.je.BACK);
                let n = e(f.vB)
                  , l = e(f.v0)
                  , a = e(h.Sp);
                (0,
        ...
        function g(e) {
            let {children: t} = e
              , n = (0,
            c.c3)("cloud-game-area")
              , l = (0,
            s.useRef)(document.querySelector("#fullscreen-element"));
            return (0,
            a.jsxs)(d.m_, {
                children: [(0,
                a.jsx)(d.k$, {
                ...
                a.jsx)(d.ZI, {
                    ...
                    children: (0,
                    a.jsx)("span", {
                        className: "text-3 lh-4",
                        children: n("ctrl-return")
                    })
                })]
            })
        }
    ...
    37545: (e, t, n) => {
        ...
        var l, a, r, i = n(6379), c = n(96820), s = n(55247), o = n(2285), u = n(60574), d = n(94907);
        function f() {
        ...
        function j(e) {
            ...
            u.c3)("cloud-game-area")
              , l = (0,
            d.useRef)(document.querySelector("#fullscreen-element"));
            return (0,
            i.jsxs)(g.m_, {
                children: [(0,
                i.jsx)(g.k$, {
    ...
    38061: (e, t, n) => {
        ...
        var l, a, r = n(6379), i = n(96820), c = n(2285), s = n(60574), o = n(94907);
        function u() {
        ...
        function p(e) {
            let {children: t} = e
              , n = (0,
            s.c3)("cloud-game-area")
              , l = (0,
            o.useRef)(document.querySelector("#fullscreen-element"));
            return (0,
            r.jsxs)(f.m_, {
                children: [(0,
                r.jsx)(f.k$, {
    ...
    46497: (e, t, n) => {
        ...
        var l, a = n(6379), r = n(2285), i = n(60574), c = n(94907);
        function s() {
        ...
        function h(e) {
            let {children: t, ...n} = e
              , {tapFullscreen: l, loadingAds: r} = (0,
            c.use)(d.a);
            return (0,
            a.jsx)("button", {
                type: "button",
        ...
        function m(e) {
            ...
            r.yF)( (e, t) => {
                var n, l, a, r;
                let {fullscreen: i} = e(f.Gl);
                i ? null == (l = window) || null == (n = l.g_setFullscreen) || n.call(l) : null == (r = window) || null == (a = r.g_exitFullscreen) || a.call(r),
                t(f.Gl, e => ({
                    ...e,
                    fullscreen: !i
                }))
        ...
        function v(e) {
            let {children: t} = e
              , n = (0,
            i.c3)("cloud-game-area")
              , l = (0,
            c.useRef)(document.querySelector("#fullscreen-element"));
            return (0,
            a.jsxs)(u.m_, {
                children: [(0,
                a.jsx)(u.k$, {
    ...
    48568: (e, t, n) => {
        ...
        var l, a = n(6379), r = n(96820), i = n(42305), c = n(55247), s = n(2285), o = n(60574), u = n(94907);
        function d() {
            return (d = Object.assign ? Object.assign.bind() : function(e) {
                for (var t = 1; t < arguments.length; t++) {
                    var n = arguments[t];
        ...
        function p(e) {
            let t = (0,
            s.yF)( (e, t) => {
                let n = !e(m.h4).isShowPresetKeyGUI;
                t(m.h4, e => ({
                    ...e,
                    isShowPresetKeyGUI: n,
                    status: n ? g.n.SHOW : g.n.HIDE
                }));
                let l = e(m.vB)
                  , a = e(m.v0)
                  , i = e(v.Sp);
        ...
        function w() {
            ...
            return (0,
            a.jsxs)("div", {
                className: "size-5 flex-center flex-col",
                children: [(0,
                a.jsx)(f, {
                    className: "aspect-ratio-9/4 h-auto w-full"
                }), (0,
                a.jsx)("div", {
                    className: "aspect-ratio-9/5 h-auto w-full flex items-end",
                    children: (0,
                    a.jsx)("i", {
                        "data-active": e.isShowPresetKeyGUI,
                        className: (0,
                        i.A)("relative block aspect-ratio-9/4 h-auto w-full rd-1 transition-all", "before:absolute before:bottom-10% before:aspect-square before:h-80% before:rd-full before:bg-white-1 before:transition-all before:content-empty", "data-[active=true]:bg-cyan-5 data-[active=true]:before:left-60%", "data-[active=false]:bg-white-1 data-[active=false]:bg-op-50 data-[active=false]:before:left-10%")
                    })
                })]
            })
        }
    ...
    70248: (e, t, n) => {
        ...
        function f(e) {
            let t = (0,
            r.yF)(e => {
                window.open("https://discord.gg/SWHpPdHnm2");
                let t = e(u.vB)
                  , n = e(u.v0)
                  , l = e(d.Sp);
                (0,
                a.sendGTMEvent)({
                    ...
                    uid: n.uid,
                    isLogged: Number(l),
                    url: "https://discord.gg/SWHpPdHnm2"
                })
            }
            );
            return (0,
    ...
    75400: (e, t, n) => {
        ...
        function o(e) {
            let {className: t, sideOffset: n=0, children: i, container: c, ...s} = e;
            return (0,
            l.jsx)(a.ZL, {
                container: c,
                children: (0,
                l.jsxs)(a.UC, {
                    ...
                    sideOffset: n,
                    className: (0,
                    r.A)("z-50 w-fit origin-[--radix-tooltip-content-transform-origin] rd-3 bg-black-3 px-3 py-1.5 c-white-1 c-op-90", "animate-keyframes-fade-in animate-duration-150", "data-[state=closed]:animate-keyframes-fade-out data-[state=closed]:animate-duration-150", t),
                    ...s,
                    children: [i, (0,
                    l.jsx)(a.i3, {
                        className: "z-50 size-2.5 translate-y-[calc(-50%-2px)] rotate-45 rd-[2px] bg-black-3 fill-black-3"
                    })]
                })
            })
        }
    ...
    81715: (e, t, n) => {
        ...
        var l = n(64299)
          ...
          , c = n(54644);
        let s = (0,
        r.tG)("EASYFUN_USERINFO", {}, void 0, {
            getOnInit: !0
        })
          , o = (0,
        r.tG)("EASYFUN_LOGIN_SOURCE", c.Pf.UNKNOWN, void 0, {
            getOnInit: !0
        })
          , u = (0,
        l.eU)(void 0)
        ...
        l.eU)(void 0)
          , f = (0,
        r.tG)("EASYFUN_LAST_UPDATE_TOKEN", 0, void 0, {
            getOnInit: !0
        })
          , h = (0,
        r.mg)(s, e => !!(null == e ? void 0 : e.token))
          , m = (0,
        l.eU)(e => new Date - e(f) >= 432e5 && e(h))
          , v = (0,
        l.eU)(!1)
          , g = (0,
        l.eU)(!1)
        ...
        a.$)( (e, t) => {
            if (e(m)) {
                ...
                if ("hasData" === a.state) {
                    ...
                    !a.data.email) {
                        var n, l;
                        a.data.email = null == (l = a.data) || null == (n = l.thirdUserInfos[0]) ? void 0 : n.thirdEmail
                    }
                    t(s, {
                        ...e(s),
                        ...a.data
