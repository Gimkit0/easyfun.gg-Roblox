"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[3489], {
    3722: (t, e, n) => {
        n.d(e, {
            A: () => s
        });
    ...
    33489: (t, e, n) => {
        ...
        var r = n(11409)
          ...
          , s = void 0 !== n.g && n.g.Math === Math ? n.g : "undefined" != typeof self && self.Math === Math ? self : "undefined" != typeof window && window.Math === Math ? window : Function("return this")()
          , c = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(s) : function(t) {
          ...
          , u = function() {
            ...
            t.prototype.connect_ = function() {
                ...
                h ? (this.mutationsObserver_ = new MutationObserver(this.refresh),
        ...
        var m = function() {
            ...
            return t.prototype.isActive = function() {
                var t = function(t) {
                    ...
                    return function(t) {
                        var e, n = t.clientWidth, r = t.clientHeight;
                        if (!n && !r)
                            return v;
                        var i = d(t).getComputedStyle(t)
                          ...
                          , a = p(i.width)
                          , h = p(i.height);
                        if ("border-box" === i.boxSizing && (Math.round(a + s) !== n && (a -= l(i, "left", "right") + s),
                        Math.round(h + c) !== r && (h -= l(i, "top", "bottom") + c)),
          ...
          , y = function(t, e) {
            var n, r, i, o, s, c = (n = e.x,
            r = e.y,
            i = e.width,
            o = e.height,
            f(s = Object.create(("undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
                x: n,
                y: r,
                width: i,
                height: o,
          ...
          , E = function t(e) {
            ...
            if (!arguments.length)
                throw TypeError("1 argument required, but only 0 present.");
            var n = new g(e,u.getInstance(),this);
            w.set(this, n)
        };
        ...
        var O = void 0 !== s.ResizeObserver ? s.ResizeObserver : E
          , A = n(3722)
          , M = n(84763)
          , T = n(24466)
          , k = n(73229)
